...
Non ancora fatto: generazione delle voci ElevenLabs, playtest reale con Pietro
su tablet, design system e nuove immagini (messaggi 2 e 3).
...
all'80%**, e Zibo dice quante parole mancano. Un traguardo visibile e' un
...
- [x] Mascotte Zibo che parla, si anima e evolve in 4 stadi (livelli 1/4/8/13)
...
|---|--------|-----------------|-----------|
| 1 | Zibo and the Red Egg | Valle dei Draghi | `What is it?` |
...
- **2026-09-03** — Build v1.0.0 completa. Verificata con test di sfoglio
  ...
  drag&drop, anatomia di Zibo e del mostro nello sprite.
...
- **2026-09-03** — Spostata in `.env` la chiave ElevenLabs che era finita in
  ...
  tracciati ne' nella storia. Lo script audio ora supporta `VOICE_ID`.
...
3. **Generare le voci ElevenLabs** (`node tools/generate-audio.mjs`) e
   riascoltarle: la sintesi del browser va bene come rete di sicurezza, non come
   esperienza.
